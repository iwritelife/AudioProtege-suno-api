      ...
      <div className="bg-black/20 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            {!credits && (
              <div className="flex items-center gap-4 bg-gradient-to-r from-amber-500/20 to-orange-500/20 backdrop-blur-sm rounded-2xl px-8 py-4 border border-amber-400/40 shadow-xl">
                <div className="flex items-center justify-center w-8 h-8 bg-amber-400/20 rounded-xl border border-amber-400/30">
                ...
                <div>
                  ...
                  <div className="text-xs text-amber-300/90 font-medium">Configure SUNO_COOKIE to enable music generation</div>
                </div>
              </div>
            )}
          </div>
